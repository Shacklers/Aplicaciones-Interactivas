            ...
            >
              ...
              >
                <Typography
                  ...
                  fontSize={{ xs: "40px", md: "50px", lg: "60px", xl: "80px" }}
                >
                  Encontra tu <br />
                  profe ideal
                </Typography>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p style={{ fontFamily: "BuenosAires", fontSize: "15px" }}>
                    Buscá con toda libertad entre varios perfiles y contactá al
                    profesor que más se acerque a tus necesidades (tarifas,
                    preparación, opiniones, el más cercano o en línea){" "}
                  </p>
                </CardContent>
              ...
              >
                ...
                >
                  <Typography variant="body2" color="textSecondary">
                    <h1 style={{ fontFamily: "BuenosAires-Black" }}>
                      2. Contactalo
                    </h1>
                    <p style={{ fontFamily: "BuenosAires", fontSize: "15px" }}>
                      Rápidamente, nuestros profesores te responderán en unas
                      cuantas horas. Y si no encontrás al profe indicado, nos
                      encargamos de ayudarte.{" "}
                    </p>
                  </Typography>
                </CardContent>
              </Box>
              ...
              >
                ...
                >
                  <Typography variant="body2" color="textSecondary">
                    ...
                    >
                      3. Pónganse de acuerdo
                    </h1>
                    <p style={{ fontFamily: "BuenosAires", fontSize: "15px" }}>
                      Intercambien algún mensaje sobre la clase en nuestra
                      mensajería y acuerden la clase juntos.{" "}
                    </p>
                  </Typography>
                </CardContent>
