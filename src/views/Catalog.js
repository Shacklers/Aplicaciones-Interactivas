                    ...
                    {categories.map((category, index) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onChange={() => {
                            handleCheckboxChange("item" + (index + 1));
                            setItem(category);
                          }}
                        />
            ...
            <Card sx={{ width: 320 }}>
              <div>
                <Typography level="title-lg">
                  {card.user} - {card.categoria}
                </Typography>
                <Typography level="body-sm">
                  {card.ubicacion} - {card["Tipo de clase"]} - {card.frecuencia}
                </Typography>
              ...
              <AspectRatio minHeight="120px" maxHeight="200px">
                <img src={card.img} srcSet={card.img} loading="lazy" alt="" />
              </AspectRatio>
